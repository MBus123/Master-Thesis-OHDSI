define(function (require, exports) {
    ...
    var CustomCodeSettings = require("./modelSettings/CustomCodeSettings");
    var utils = require('../utils');
    var CustomCodeService = require('services/CustomCode');
    ...
    function GetSettingNameFromObject(data) {
		...
		} else if (data.hasOwnProperty("CustomCodeSettings")) {
	...
	function GetSettingsFromObject (data)
	{
		switch (this.GetSettingNameFromObject(data)) {
            ...
            case 'LassoLogisticRegressionSettings':
                ...
                break;
            case 'CustomCodeSettings':
                return {
                    CustomCodeSettings: new exports.CustomCodeSettings(data.CustomCodeSettings)
                };
                break;
            default:
    ...
    exports.CustomCodeSettings = CustomCodeSettings;
    ...
    exports.options = [
        ...
        {
            key: 'CustomCodeSettings',
            name: 'Custom Code',
            editor: 'custom-code-settings',
            action: () => {
                const defaultValues = utils.getDefaultModelSettingsValueList('CustomCodeSettings');
                //CustomCodeService.getCustomCodes().then(function(result) {
                //    defaultValues.custom_parameters =  result.data;
                //     });
                return {
                    CustomCodeSettings: new CustomCodeSettings(defaultValues)
                };
            },
        },
    ];
